        ...
        <section className="py-14 sm:py-20" aria-labelledby="mode-title">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              TemanUsaha AI membantu pemilik UMKM memahami cara AI agent mencatat tindakan,
              membaca data, dan menunjukkan hasilnya secara transparan.
            </p>
          </div>

          <div
            aria-label="Pilihan Mode Demo dan Mode Real"
              ...
              <div className="grid gap-7 p-6 sm:p-8">
                <div>
                  ...
                  <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground">
                    Lihat order, stok, ringkasan, dan aktivitas AI berubah pada satu skenario yang aman untuk dipelajari.
                  </p>
                </div>
            ...
            <article className="flex min-h-full flex-col rounded-md border border-border bg-card p-6 sm:p-8">
              ...
              <div className="mt-10">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Daftar akun, buat profil usaha, lalu pantau pesanan, stok, dan omzet secara realtime di workspace Anda.
                </p>
              </div>
