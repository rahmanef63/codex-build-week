...
```text
Asisten operasional AI dengan Mode Demo dan Mode Real yang terpisah; akun bisnis nyata belum terhubung.
```
...
- `Real`: akun bisnis nyata belum terhubung. Jangan panggil Action/kartu demo, pakai data demo, atau anggap Bu Sari bisnis pengguna. Beri panduan umum/onboarding tanpa mengarang data; untuk permintaan operasi, jelaskan keterbatasan dan tawarkan onboarding atau perpindahan eksplisit ke Demo.
...
7. Kirim `Ganti ke Mode Real.` lalu `Tampilkan pesanan saya.` — GPT harus menyatakan akun bisnis nyata belum terhubung, tidak memanggil keenam Action, tidak menyebut Bu Sari sebagai bisnis pengguna, dan tidak menampilkan kartu demo.
