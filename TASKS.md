...
| In progress | Validate the live GPT Actions contract against Convex Cloud | Beta | GPT-5 Codex |
| In progress | Publish and verify a Vercel preview deployment | Gamma | GPT-5 Codex |
| In progress | Audit GitHub authentication, remote, and Codex Cloud readiness | Reviewer | GPT-5 Codex |
| Todo | Import Action/Instructions and test in Custom GPT Preview | User + Alpha | ChatGPT action-capable model |
| Todo | Deploy Next.js dashboard and add repo/demo/video URLs to submission | User + Alpha | GPT-5 Codex |
