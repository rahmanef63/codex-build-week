...
interface ThemePresetSwitcherProps {
  ...
  /** The popover portals to document.body, so it escapes any `dark` class a
   *  route forces on its own subtree. Pass "dark" from a force-dark page
   *  (landing, /setup) or a light-theme visitor gets a light popover on it. */
  ...
  return (
    ...
    >
      ...
      <PopoverContent
        ...
        sideOffset={8}
        className={cn(
          "flex h-[min(80vh,34rem)] w-[min(20rem,calc(100vw-1rem))] sm:w-80 flex-col overflow-hidden p-0",
          contentClassName,
        )}
