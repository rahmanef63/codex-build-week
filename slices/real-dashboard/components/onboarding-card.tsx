  ...
  return (
    <div className="dash-center">
      <section aria-labelledby="dash-onboarding-title" className="dash-card dash-onboarding">
        ...
        <h1 id="dash-onboarding-title">Buat ruang kerja Anda</h1>
        <p className="dash-muted">
          Beri nama ruang kerja ini. Produk dapat ditambahkan sekarang atau nanti dari dashboard.
        </p>
        ...
        >
          <label className="dash-label">
            ...
            <input
              ...
              placeholder="mis. Ruang Kerja Saya"
              required
              value={name}
            />
          </label>
